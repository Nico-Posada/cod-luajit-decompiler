class Ast {
  private:
    ...
    enum CONSTANT_TYPE { INVALID_CONSTANT, NIL_CONSTANT, BOOL_CONSTANT, NUMBER_CONSTANT };
...
#include "conditionBuilder.h"
    ...
    void build_if_statements_from_map(
        Function& function,
        std::vector<Statement*>& block,
        BlockInfo* const& previousBlock,
    ...
    static uint32_t get_label_from_next_statement(
