...
enum AST_VARIABLE { AST_VARIABLE_SLOT, AST_VARIABLE_UPVALUE, AST_VARIABLE_GLOBAL, AST_VARIABLE_TABLE_INDEX };
...
enum AST_UNARY_OPERATION { AST_UNARY_MINUS, AST_UNARY_NOT, AST_UNARY_LENGTH };
...
struct Statement {
    ...
    struct {
        ...
        template <typename... Expressions> void register_slots(Expression*& expression, Expressions*&... expressions) {
            openSlots.emplace_back(&expression);
